...
- Backend → Бот: `http://38.244.193.239:8080/internal/*` + `X-Internal-Key` (plain HTTP, ufw на боте пропускает только Timeweb IP)
...
| Firewall (ufw) | 22/tcp anywhere, 8080/tcp **только** от Timeweb IP, остальное deny |
